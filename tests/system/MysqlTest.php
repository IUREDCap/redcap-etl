...
class MysqlTest extends TestCase
{
    ...
    public function testMysqlDbConnectionCreateTableWithPort()
    {
        ...
        $this->processMysqli($dbString, "drop table if exists $name;");
        ...
        $expectedMessage4 = "Table 'test_etl_table' already exists";
    ...
    */
    public function testMysqlDbConnectionInsertRows()
    {
        ...
        $this->processMysqli($dbString, "drop table if exists $name2;");
        $mysqlDbConnection->createTable($rootTable2, false);

        $exceptionCaught = false;
        $expectedMessage = "Data too long for column 'full_name' at row 2";
    ...
    public function testMysqlDbConnectionInsertRow()
    {
        ...
        $expectedMessage6 = "Data too long for column 'full_name' at row 1";
        $row1 = $rows[1];
        try {
    ...
    public function testMysqlDbConnectionProcessQueryFile()
    {
        ...
        #first, drop the table, in case it wasn't dropped from a prior test.
        $this->processMysqli($dbString, "drop table if exists queryTest01;");
        $this->processMysqli($dbString, "drop table if exists queryTest02;");
        ...
        ###a bad third query
        #first, drop the table, in case it wasn't dropped from a prior test.
        $this->processMysqli($dbString, "drop table if exists queryTest03;");
        $this->processMysqli($dbString, "drop table if exists queryTest04;");
    ...
    public function testMysqlDbConnectionReplaceLookupViewWithoutLookup()
    {
        ...
        #drop the table and view
        $this->processMysqli($dbString, "drop table if exists $name;");
        $this->processMysqli($dbString, "drop view  if exists $name$labelViewSuffix;");
    }
