...
class DynamicRulesLongitudinalTest extends TestCase
{
    ...
    #const CONFIG_FILE = '/home/naalong/redcap-etl/tests/config/repeating-events.ini';
    const CONFIG_FILE = __DIR__.'/../config/repeating-events.ini';

    #const TEST_DATA_DIR   = '/home/naalong/redcap-etl/tests/data/';     # directory with test data comparison files
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$properties = $config->getProperties();
        ...
        self::$properties[ConfigProperties::AUTOGEN_COMBINE_NON_REPEATING_FIELDS] = 'false';
        ...
        self::$contactInformationCsvLabelFile = self::$csvDir 
            . 'dr_contact_information'.self::$config->getlabelViewSuffix().'.csv';
