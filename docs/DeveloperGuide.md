...
* __tests/__ - automated tests directory
    ...
    * __logs__ - test log files (ignored by Git)
    * __output__ - test generate output files (ignored by Git)
    * __projects__ - test REDCap projects
    * __system/__ - code for system tests
    * __unit/__ - code for unit tests 
* __vendor/__ - directory where the depedencies generated by Composer
are installed
