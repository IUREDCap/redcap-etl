...
{
    const DEFAULT_NAME      = 'metadata';
    
    const FIELD_PRIMARY_ID         = 'metadata_id';
    const FIELD_TABLE_NAME         = 'table_name';
    const FIELD_FIELD_NAME         = 'field_name';
    const FIELD_REDCAP_FIELD_NAME  = 'redcap_field_name';
    const FIELD_IDENTIFER          = 'identifier';
    ...
    public function __construct($lookupChoices, $tablePrefix, $keyType, $name = self::DEFAULT_NAME)
    {
        ...
        $fieldFieldName  = new Field(self::FIELD_TABLE_NAME, FieldType::VARCHAR, 255);
        $fieldTableName  = new Field(self::FIELD_FIELD_NAME, FieldType::VARCHAR, 255);
        $fieldIdentifier = new Field(self::FIELD_IDENTIFIER, FieldType::INT);
