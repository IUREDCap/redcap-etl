...
class Configuration
{
    ...
    private $autoGenerateCompleteFields;  // For auto-generate case, generate form complete fields
    private $autoGenerateDagFields;       // For auto-generate case, generate DAG (Data Access Group) fields
    ...
    public function getAutoGenerateCompleteFields()
    {
        return $this->autoGenerateCompleteFields;
    }

    public function getAutoGenerateDagFields()
    {
        return $this->autoGenerateDagFields;
    }
}
